...
{/* estilos de los botones de los temas */}
  const obtenerEstiloBoton = (nombreTema) => {
    ...
    return {
      backgroundColor: esActivo
        ? nombreTema === "Claro"
          ? "#E28EB8"  //color-accent3, cuando alterna a blanco cambia a un rosa bb (Segun fgima)
          : "#D868A0" // color accent 2 rosado normal
        : "var(--color-unselect)",
      color: colorTexto,
    };
  };
...
.panel-container {
  position: fixed;
  left: 50%;
  top: calc(60px + 40px); /* misma distancia siempre */
